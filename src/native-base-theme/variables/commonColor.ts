...
export default {
  ...
  // Color
  brandPrimary: platform === 'ios' ? colors.secondary : colors.secondary,
  brandInfo: '#62B1F6',
  brandSuccess: colors.success,
  brandDanger: colors.danger,
  brandWarning: '#f0ad4e',
  brandDark: colors.darkGray,
  brandLight: colors.offWhite,

  //Date Picker
  datePickerTextColor: colors.text,
  ...
  subtitleColor: platform === 'ios' ? colors.text : colors.inverseText,
  titleFontColor: platform === 'ios' ? colors.text : colors.inverseText,
